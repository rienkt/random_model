MODULE nr
  ...
  INTERFACE gammp
     ...
     FUNCTION gammp_v_sp(a,x)
       ...
       REAL(SP), DIMENSION(size(a)) :: gammp_v_sp
     ...
     FUNCTION gammp_v_dp(a,x)
       ...
       REAL(DP), DIMENSION(size(a)) :: gammp_v_dp
 ...
 END INTERFACE
  ...
  INTERFACE rlft2
     ...
     SUBROUTINE rlft2_dp(data,spec,speq,isign)
       USE nrtype
       REAL(DP), DIMENSION(:,:), INTENT(INOUT) :: data
       COMPLEX(DPC), DIMENSION(:,:), INTENT(OUT) :: spec
       COMPLEX(DPC), DIMENSION(:), INTENT(OUT) :: speq
       INTEGER(I4B), INTENT(IN) :: isign
