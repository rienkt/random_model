#!/bin/sh
# This is a subprogram for exec.sh
#   Run $exe and generate spectrals or random fields.
#   
#   Output files of $exe shoule be
#      double, binary, fortran (estimating spectral)
#      single, binary, direct  (generating rnd. fields)
#
